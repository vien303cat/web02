...
CREATE TABLE `article` (
  `article_seq` int(10) UNSIGNED NOT NULL,
  `article_title` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `article_cnt` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `article_display` int(2) NOT NULL
...
INSERT INTO `article` (`article_seq`, `article_title`, `article_cnt`, `article_display`) VALUES
...
CREATE TABLE `log` (
  `log_seq` int(10) NOT NULL,
  `log_acc` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `log_newseq` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `log` (`log_seq`, `log_acc`, `log_newseq`) VALUES
(13, 'flan', 3),
(16, 'zzz', 1),
(19, 'zzz', 3),
(22, 'flan', 2),
...
CREATE TABLE `member` (
  `member_seq` int(10) UNSIGNED NOT NULL COMMENT '索引鍵',
  `member_acc` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '帳號',
  `member_pw` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '密碼',
  `member_email` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '信箱'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `member` (`member_seq`, `member_acc`, `member_pw`, `member_email`) VALUES
(1, 'admin', '1234', 'google'),
(2, 'flan', 'flan', '666'),
(3, 'zzz', 'zzz', 'zzz'),
(4, 'www', 'www', 'www');
...
CREATE TABLE `player` (
  `player_seq` int(10) UNSIGNED NOT NULL COMMENT '索引鍵',
  `player_cnt` int(10) NOT NULL COMMENT '人數',
  `player_day` date NOT NULL COMMENT '時間'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `player` (`player_seq`, `player_cnt`, `player_day`) VALUES
(1, 25, '2018-07-17'),
(2, 120, '2018-07-16'),
(3, 2, '2018-07-18'),
(4, 2, '2018-07-19'),
...
CREATE TABLE `qa` (
  `qa_seq` int(10) UNSIGNED NOT NULL,
  `qa_title` text COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `qa` (`qa_seq`, `qa_title`) VALUES
(2, '問題一：你最常做什麼運動來促進健康體能呢?'),
(3, '問題二：二手菸沒有安全劑量，只要有暴露，就會有危險，請問它會造成身體上哪些危害?');
...
CREATE TABLE `qa_log` (
  `qa_log_seq` int(10) NOT NULL,
  `qa_log_titleseq` int(10) NOT NULL,
  `qa_log_select` int(10) NOT NULL,
  `qa_log_acc` text COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `qa_log` (`qa_log_seq`, `qa_log_titleseq`, `qa_log_select`, `qa_log_acc`) VALUES
(3, 2, 22, 'flan'),
(4, 2, 22, 'flan'),
(5, 2, 20, 'flan'),
(6, 3, 28, 'flan'),
...
CREATE TABLE `qa_select` (
  `qa_select_seq` int(10) NOT NULL,
  `qa_select_qaseq` int(10) NOT NULL,
  `qa_select_con` text COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `qa_select` (`qa_select_seq`, `qa_select_qaseq`, `qa_select_con`) VALUES
(20, 2, '1.健走或爬樓梯、慢跑等較不受時間、場地限制的運動。'),
(21, 2, '2.仰臥起坐、抬腿及伏地挺身、伸展操、瑜珈等室內運動。'),
(22, 2, '3.球類運動、游泳、跳舞、騎腳踏車等加強心肺功能的運動。'),
(23, 2, '4.舉重鍛鍊、彈力帶、啞鈴等運用輔助器材鍛鍊肌耐力的運動。'),
(24, 3, ' 1.增加罹患冠狀動脈心臟病及罹病死亡之風險。'),
(25, 3, '2.對孩子的的健康會產生許多影響，例如容易咳嗽或打噴嚏、罹患氣喘或讓症狀更嚴重、會因刺激耳咽管，感染中耳炎、肺功能較差、容易罹患呼吸道疾病等。'),
(26, 3, '3.孕婦吸入二手菸易造成流產、早產、胎盤早期剝離、子宮感染等疾病。'),
(27, 3, '4.長期的暴露會造成更嚴重的胸腔問題和過敏症，還會增加心臟病和肺癌的罹患率。'),
(28, 3, '5.以上皆是。');
...
--
ALTER TABLE `player`
  ADD PRIMARY KEY (`player_seq`);

--
-- 資料表索引 `qa`
--
ALTER TABLE `qa`
  ADD PRIMARY KEY (`qa_seq`);

--
-- 資料表索引 `qa_log`
--
ALTER TABLE `qa_log`
  ADD PRIMARY KEY (`qa_log_seq`);

--
-- 資料表索引 `qa_select`
--
ALTER TABLE `qa_select`
  ADD PRIMARY KEY (`qa_select_seq`);
...
--
ALTER TABLE `article`
  MODIFY `article_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- 使用資料表 AUTO_INCREMENT `log`
--
ALTER TABLE `log`
  MODIFY `log_seq` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- 使用資料表 AUTO_INCREMENT `member`
--
ALTER TABLE `member`
  MODIFY `member_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '索引鍵', AUTO_INCREMENT=5;

--
-- 使用資料表 AUTO_INCREMENT `player`
--
ALTER TABLE `player`
  MODIFY `player_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '索引鍵', AUTO_INCREMENT=9;

--
-- 使用資料表 AUTO_INCREMENT `qa`
--
ALTER TABLE `qa`
  MODIFY `qa_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- 使用資料表 AUTO_INCREMENT `qa_log`
--
ALTER TABLE `qa_log`
  MODIFY `qa_log_seq` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- 使用資料表 AUTO_INCREMENT `qa_select`
--
ALTER TABLE `qa_select`
  MODIFY `qa_select_seq` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
COMMIT;
