...
<fieldset class="mm mm2" id="aa1" onclick="openmenu('a1')">健康新知</fieldset>
<fieldset class="mm" id="aa2" onclick="openmenu('a2')">菸害防治</fieldset>
<fieldset class="mm" id="aa3" onclick="openmenu('a3')">癌症防治</fieldset>
<fieldset class="mm" id="aa4" onclick="openmenu('a4')">慢性病防治</fieldset>
<fieldset id="apple">
<!--a1--><!--a1--><!--a1--><!--a1--><!--a1--><!--a1--><!--a1--><!--a1--><!--a1-->
<span id="a1" class="appletxt" style="display:block;">
...
function openmenu(xx){
    closemenu();
    $("#"+xx).show();
    $("#a"+xx).attr("class","mm mm2");
    //document.getElementById(ww).style.background-color="#F00";
}
function closemenu(){
    $("fieldset").attr("class","mm");
    $(".appletxt").hide();
}
</script>